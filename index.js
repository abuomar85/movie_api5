...
const express = require('express'),
    ...
    let auth = require('./auth')(app);
     const passport = require('passport');
      ...
      mongoose.connect('mongodb+srv://abuomaralyabrode85:Abu.0796422917@cluster0.usnlqqf.mongodb.net/movie_api2?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true});
